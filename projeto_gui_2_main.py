...
repetir_senha_conta = validar_entrada_texto_cadastro_conta_corrente('REPITA SUA SENHA: ')

while repetir_senha_conta != senha_conta:
...
def depositar():
  ...
  senha = input("Senha: ")
  if conta == numero_conta and senha == senha_conta:
...
def sacar():
  ...
  print(f"O seu saldo atual é de R$ {saldo_f:.2f}")
  input('Pressione ENTER para continuar...')
